		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#bpmaint00bpmaint00-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"bpmaint00bpmaint00-display": {
								"semanticObject": "bpmaint00bpmaint00",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=bpmaint00.bpmaint00",
									"url": sap.ui.require.toUrl("bpmaint00/bpmaint00")
								}
							}
						}
					}
